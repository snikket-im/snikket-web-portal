...
ENV SNIKKET_TWEAK_PORTAL_INTERNAL_HTTP_INTERFACE=0.0.0.0
ENV SNIKKET_TWEAK_PORTAL_INTERNAL_HTTP_PORT=5765

HEALTHCHECK CMD nc -zv ${SNIKKET_TWEAK_PORTAL_INTERNAL_HTTP_INTERFACE} ${SNIKKET_TWEAK_PORTAL_INTERNAL_HTTP_PORT}
